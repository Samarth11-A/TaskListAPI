...
func (c *taskListClient) CreateTask(ctx context.Context, in *CreateTaskRequest, opts ...grpc.CallOption) (*Task, error) {
...
func (c *taskListClient) GetTask(ctx context.Context, in *GetTaskRequest, opts ...grpc.CallOption) (*Task, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Task)
...
func (c *taskListClient) UpdateTask(ctx context.Context, in *UpdateTaskRequest, opts ...grpc.CallOption) (*Task, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Task)
...
func (UnimplementedTaskListServer) CreateTask(context.Context, *CreateTaskRequest) (*Task, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateTask not implemented")
}
func (UnimplementedTaskListServer) GetTask(context.Context, *GetTaskRequest) (*Task, error) {
...
func (UnimplementedTaskListServer) UpdateTask(context.Context, *UpdateTaskRequest) (*Task, error) {
...
var TaskList_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/proto/tasklist.proto",
}
